    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="<?php echo e(route('cms.users')); ?>" aria-expanded="false">
                        <i data-feather="home" class="feather-icon"></i>
                        <span class="hide-menu">Pending User</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="<?php echo e(route('cms.active.users')); ?>" aria-expanded="false">
                        <i data-feather="home" class="feather-icon"></i>
                        <span class="hide-menu">Aktif User</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="<?php echo e(route('cms.inactive.users')); ?>" aria-expanded="false">
                        <i data-feather="home" class="feather-icon"></i>
...
<!-- ============================================================== -->
<?php /**PATH D:\Kuliah\Semester 5\Magang\bkd-mutasi\resources\views\partials\sidebar.blade.php ENDPATH**/ ?>