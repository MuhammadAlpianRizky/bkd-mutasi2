 ...
 <div id="step-2" class="card d-none shadow-lg">
    ...
    <div class="card-body">
            ...
            <div class="col-12">
                ...
                <?php else: ?>
                    <div class="input-group mb-3">
                        <input type="file" class="form-control" id="sk_cpns" name="sk_cpns" accept=".pdf"
                            aria-describedby="upload-help-sk_cpns" onchange="showFileLink('sk_cpns', 'view-sk_cpns')">
                        <a id="view-sk_cpns" href="<?php echo e($mutasi->sk_cpns ? Storage::url($mutasi->sk_cpns) : '#'); ?>"
                        target="_blank"
                        class="btn btn-outline-info <?php echo e($mutasi->sk_cpns ? '' : 'd-none'); ?>"
        ...
        </div><?php /**PATH D:\Kuliah\Semester 5\Magang\bkd-mutasi\resources\views\partials\step2.blade.php ENDPATH**/ ?>